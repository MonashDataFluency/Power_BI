...
Our number one recommendation is to read the ["Power BI Guided Learning"](https://docs.microsoft.com/en-us/power-bi/guided-learning/?WT.mc_id=PBIService_GettingStarted) by Microsoft.

Also, you can visit the [Microsoft Power BI Blog](https://powerbi.microsoft.com/en-us/blog/) for the latest updates on performance improvements, more visulization options and so on. There is a community of forums and blogs for you to discuss with others.
