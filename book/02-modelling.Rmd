...
knitr::include_graphics("figures/ch03/2.1_Importing_data.png")
```

Once we select this, we go ahead and select the "**CSV option**" under the "**file**" subheading. 

```{r, fig.align = 'center', out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/ch03/2.1.2_Importing_data.png")
```
...
```{r, fig.align = 'center', out.width = "100%", echo = FALSE}
knitr::include_graphics("figures/ch03/2.1.4_Importing_data.png")
```
