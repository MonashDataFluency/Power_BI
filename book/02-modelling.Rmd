...
Right click on top of the column and select the **Change type**.
Change to **Decimal Number**.

### {-}

You can replace a current step in the query with **Replace current step** or add a new step to the query with **Add new step**. Click **Add new step**.
