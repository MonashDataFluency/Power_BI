...
knitr::include_graphics("figures/Ch01/AppStore.png")
```
...
```{r, fig.align = 'center', out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/Ch01/SoftwareCenter.png")
```
...
knitr::include_graphics("figures/Ch01/WebInstall.png")
```
...
knitr::include_graphics("figures/Ch01/Service.png")
```

After the setup process, you will be able to see the following Start Screen. 

```{r, fig.align = 'center', out.width = "80%", echo = FALSE}
knitr::include_graphics("figures/Ch01/WelcomePage.png")
```
