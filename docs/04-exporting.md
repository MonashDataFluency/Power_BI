...
No we want to create a report of our analysis and share it with others. We use Power BI to publish the report on the Power BI server.

To do this, go to **File > Publish > Publish to Power BI**.

<img src="figures/ch05/publish1.png" width="100%" style="display: block; margin: auto;" />
